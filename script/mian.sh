...
# 下载规则
curl -o i-1.txt https://raw.githubusercontent.com/Cats-Team/AdRules/main/dns.txt
curl -o i-2.txt https://www.kbsml.com/wp-content/uploads/adblock/adguard/adg-kall-dns.txt
curl -o i-3.txt https://gitlab.com/hagezi/mirror/-/raw/main/dns-blocklists/adblock/light.txt
...
curl -o i-6.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_21.txt
