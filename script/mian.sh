...
curl -o i-4.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_34.txt
...
curl -o i-7.txt https://adguardteam.github.io/HostlistsRegistry/assets/filter_38.txt
